...
def upgrade() -> None:
    ...
    op.drop_table('worker_taskmeta')
    op.drop_table('worker_tasksetmeta')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('worker_tasksetmeta',
    ...
    sa.PrimaryKeyConstraint('id', name=op.f('worker_tasksetmeta_pkey')),
    sa.UniqueConstraint('taskset_id', name=op.f('worker_tasksetmeta_taskset_id_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    op.create_table('worker_taskmeta',
    sa.Column('id', sa.INTEGER(), autoincrement=False, nullable=False),
    ...
    sa.PrimaryKeyConstraint('id', name=op.f('worker_taskmeta_pkey')),
    sa.UniqueConstraint('task_id', name=op.f('worker_taskmeta_task_id_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
