...
# 创建全局实例（延迟初始化）
_task_status_calculator: Optional[RuntimeStatusCalculator] = None


def get_task_status_calculator() -> RuntimeStatusCalculator:
    """获取任务状态计算器实例"""
    global _task_status_calculator
    if _task_status_calculator is None:
        from app.core.scheduler import scheduler
        _task_status_calculator = RuntimeStatusCalculator(scheduler.scheduler)
